    ...
    <section className="w-full h-[100%] relative flex flex-col items-center justify-between text-black">
      ...
      <div className="w-full flex justify-end p-4 space-x-4">
        <button
          ...
          className="bg-blue-500 text-black font-anton border-4 border-black px-11 py-2 rounded-3xl hover:bg-blue-700"
        >
          ROADMAP
        </button>
        <a
          ...
          className="bg-blue-500 text-white border-4 border-black px-6 py-2 rounded-3xl hover:bg-blue-700 flex items-center"
        >
